...
function createComponents()
{
    with (swingNames) {
         ...
         */
        var pane = new JPanel();
        pane.border = BorderFactory.createEmptyBorder(130, //top
                                                      130, //left
                                                      210, //bottom
                                                      330); //right
...
with (swingNames) {
    ...
    // This would work at on time but now it doesn't..see alternative below
    ...
    */
    ...
    // Alternative way to connect to Window Events
